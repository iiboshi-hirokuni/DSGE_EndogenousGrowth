...
erase_compiled_function('EGver1_static');
erase_compiled_function('EGver1_dynamic');
M_.orig_eq_nbr = 50;
M_.eq_nbr = 50;
M_.ramsey_eq_nbr = 0;
...
estim_params_.param_vals = [estim_params_.param_vals; 8, NaN, NaN, NaN, 2, 3.000, 1.500, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 48, NaN, NaN, NaN, 1, 0.025, 0.003, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 7, NaN, NaN, NaN, 2, 0.500, 0.075, NaN, NaN, NaN ];
...
estim_params_.param_vals = [estim_params_.param_vals; 12, NaN, NaN, NaN, 1, 0.375, 0.100, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 16, NaN, NaN, NaN, 1, 0.375, 0.100, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 19, NaN, NaN, NaN, 1, 0.80, 0.100, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 20, NaN, NaN, NaN, 2, 1.700, 0.100, NaN, NaN, NaN ];
...
estim_params_.param_vals = [estim_params_.param_vals; 70, NaN, NaN, NaN, 1, 0.500, 0.100, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 71, NaN, NaN, NaN, 1, 0.500, 0.100, NaN, NaN, NaN ];
...
options_.mode_file = 'EGver1_mode.mat';
...
save('EGver1_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('EGver1_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('EGver1_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('EGver1_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('EGver1_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('EGver1_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('EGver1_results.mat', 'oo_recursive_', '-append');
end
