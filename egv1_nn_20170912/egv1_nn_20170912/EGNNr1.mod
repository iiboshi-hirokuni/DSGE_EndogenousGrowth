...
//stoch_simul(irf=40,pruning,loglinear,order=1,graph_format = fig)
//Y   C    I
//R_N PPI  W
//L   Z_LAMBDA  MU_A;
...
//ESTIMATION_______________________________________________________________
    ...
    estimated_params;
       %hab       , ,     ,     ,beta_pdf ,0.700,0.100;
        ...
        zeta_ainv , ,     ,     ,gamma_pdf,3.000,0.500;%Åö
       %mu_ass    , ,     ,     ,gamma_pdf,1.005,0.001;
        lambdass  , ,     ,     ,beta_pdf ,0.025,0.003;%Åö
        omega_a   , ,     ,     ,gamma_pdf,0.500,0.010;%Åö
       ...
       %xi_w      , ,     ,     ,beta_pdf ,0.375,0.100;%Hirose(2012)
        ...
        phi_r    , ,     ,     ,beta_pdf ,0.800 ,0.200 ;%Hirose(2012) 
        phi_pi   , ,     ,     ,gamma_pdf,1.700 ,0.200 ;%Hirose(2012)
        ...
        rho_p     , ,     ,     ,beta_pdf ,0.500,0.200;
        rho_w     , ,     ,     ,beta_pdf ,0.500,0.200;
